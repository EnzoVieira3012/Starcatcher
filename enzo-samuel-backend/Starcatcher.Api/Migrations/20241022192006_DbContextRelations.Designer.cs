...
namespace Starcatcher.Api.Migrations
{
    ...
    [Migration("20241022192006_DbContextRelations")]
    partial class DbContextRelations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Starcatcher.Domain.Entities.Consortium", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ConsortiumId = 1,
                            CreatedAt = new DateTime(2024, 10, 22, 16, 20, 6, 128, DateTimeKind.Local).AddTicks(8650),
                        ...
                        {
                            ConsortiumId = 2,
                            CreatedAt = new DateTime(2024, 10, 22, 16, 20, 6, 128, DateTimeKind.Local).AddTicks(8658),
                        ...
                        {
                            ConsortiumId = 3,
                            CreatedAt = new DateTime(2024, 10, 22, 16, 20, 6, 128, DateTimeKind.Local).AddTicks(8663),
            ...
            modelBuilder.Entity("Starcatcher.Domain.Entities.Wallet", b =>
                {
                    b.HasOne("Starcatcher.Domain.Entities.User", "User")
                        .WithOne("Wallet")
                        .HasForeignKey("Starcatcher.Domain.Entities.Wallet", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
